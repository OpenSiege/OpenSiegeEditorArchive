...
#line 129 "E:/Programming/Projects/gitea/GameState/build/FuelParser.cpp" // lalr1.cc:479
  ...
  inline
   FuelParser ::syntax_error::syntax_error (const std::string& m)
    : std::runtime_error (m)
  {}
  ...
  inline
   FuelParser ::basic_symbol<Base>::basic_symbol ()
    : value ()
  {}

  template <typename Base>
  inline
   FuelParser ::basic_symbol<Base>::basic_symbol (const basic_symbol& other)
    : Base (other)
    , value ()
  {
    value = other.value;
  ...
  template <typename Base>
  inline
   FuelParser ::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const semantic_type& v)
    : Base (t)
    , value (v)
  {}
  ...
  inline
  void
   FuelParser ::basic_symbol<Base>::clear ()
  {
    Base::clear ();
  }
  ...
  inline
  bool
   FuelParser ::basic_symbol<Base>::empty () const
  {
  ...
  // by_type.
  inline
   FuelParser ::by_type::by_type ()
    : type (empty_symbol)
  {}

  inline
   FuelParser ::by_type::by_type (const by_type& other)
    : type (other.type)
  {}

  inline
   FuelParser ::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}

  inline
  void
   FuelParser ::by_type::clear ()
  {
    type = empty_symbol;
  }
  ...
  inline
  void
   FuelParser ::by_type::move (by_type& that)
  {
    type = that.type;
    that.clear ();
  }
  ...
  inline
  int
   FuelParser ::by_type::type_get () const
  {
    return type;
  }
  ...
  // by_state.
  inline
   FuelParser ::by_state::by_state ()
    : state (empty_state)
  {}

  inline
   FuelParser ::by_state::by_state (const by_state& other)
    : state (other.state)
  {}

  inline
  void
   FuelParser ::by_state::clear ()
  {
    state = empty_state;
  }
  ...
  inline
   FuelParser ::by_state::by_state (state_type s)
    : state (s)
  {}

  inline
   FuelParser ::symbol_number_type
   FuelParser ::by_state::type_get () const
  {
  ...
  inline
   FuelParser ::stack_symbol_type::stack_symbol_type (state_type s, symbol_type& that)
    : super_type (s)
  {
    value = that.value;
    // that is emptied.
  ...
  template <typename Base>
  void
   FuelParser ::yy_print_ (std::ostream& yyo,
  ...
  inline
  void
   FuelParser ::yypush_ (const char* m, state_type s, symbol_type& sym)
  {
  ...
  inline
  void
   FuelParser ::yypush_ (const char* m, stack_symbol_type& s)
  {
    if (m)
      YY_SYMBOL_PRINT (m, s);
    yystack_.push (s);
  ...
  inline
  void
   FuelParser ::yypop_ (unsigned int n)
  {
    yystack_.pop (n);
  }
...
#line 632 "E:/Programming/Projects/gitea/GameState/build/FuelParser.cpp" // lalr1.cc:859
  ...
  std::string
   FuelParser ::yysyntax_error_ (state_type, const symbol_type&) const
  {
  ...
  {
  "$end", "error", "$undefined", "\"expression\"", "\"identifier\"",
  "'['", "']'", "'{'", "'}'", "':'", "','", "'='", "';'", "$accept",
  "translation_unit", "element", "element_name", "element_body",
  ...
  const unsigned char
   FuelParser ::yyrline_[] =
  {
       0,    58,    58,    62,    63,    72,    73,    74,    82,    84,
      88,    89,    93,    94,    98,    99,   103,   107,   108,   111,
     113,   124,   128,   129
  };

  // Print the state stack on the debug stream.
  void
   FuelParser ::yystack_print_ ()
  {
    *yycdebug_ << "Stack now";
  ...
  void
   FuelParser ::yy_reduce_print_ (int yyrule)
  {
